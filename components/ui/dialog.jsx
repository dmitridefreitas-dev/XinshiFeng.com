  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'bg-white/97 border border-gray-200 shadow-xl rounded-xl',
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-1 text-muted hover:text-foreground hover:bg-gray-100 transition-colors focus:outline-none">
        <X className="h-4 w-4" />
