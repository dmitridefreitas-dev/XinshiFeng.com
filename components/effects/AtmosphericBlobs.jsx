...
const BLOBS = [
  // [x%, y%, w, h, color (variable), driftDuration, opacityBase, phase]
  ['22.5%', '12%',  '55vw', '55vw', 'var(--accent-glow)',        28, 0.7, 0],
  ['68%', '8%',   '45vw', '45vw', 'var(--accent-glow-subtle)', 36, 0.6, 1],
  ['5%',  '52%',  '40vw', '40vw', 'var(--accent-glow-subtle)', 22, 0.6, 2],
  ['72%', '55%',  '50vw', '50vw', 'var(--accent-glow-subtle)', 42, 0.5, 3],
  ['40%', '80%',  '35vw', '35vw', 'var(--accent-glow-strong)', 18, 0.5, 4],
];
