...
const BLOBS = [
  ...
  ['18%', '12%',  '55vw', '55vw', 'rgba(37,99,235,0.07)',   28, 0.7, 0],
  ['68%', '8%',   '45vw', '45vw', 'rgba(124,58,237,0.05)',  36, 0.6, 1],
  ['5%',  '52%',  '40vw', '40vw', 'rgba(79,70,229,0.05)',   22, 0.6, 2],
  ['72%', '55%',  '50vw', '50vw', 'rgba(37,99,235,0.04)',   42, 0.5, 3],
  ['40%', '80%',  '35vw', '35vw', 'rgba(16,185,129,0.04)', 18, 0.5, 4],
];
