...
export default function MagneticButton({
  ...
  const variants = {
    default:
      'border border-accent text-accent bg-transparent hover:bg-accent/10 hover:text-accent-indigo shadow-[3px_3px_0px_0px_var(--accent-base)] hover:shadow-none hover:translate-y-[3px] hover:translate-x-[3px] transition-all rounded-none',
    outline:
      'border border-border text-accent hover:bg-[var(--accent-glow-subtle)] hover:border-[var(--accent-glow-strong)] rounded-none',
    ghost: 'text-muted hover:text-foreground hover:bg-[var(--surface-hover)] rounded-none',
  };
